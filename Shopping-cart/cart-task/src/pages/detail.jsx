...
// import  removeCart  from "../assests/images/removeCart"
  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-2 gap-5 mt-5'>
              <div>
          <img src={detail.images} alt="" className='w-full'/>
          </div>
          <div className='flex flex-col gap-5'>
            <h1 className='text-4xl uppsercase font-bold'>{detail.name}</h1>
            <p className='font-bold text-3xl'>
              ${detail.price}
            </p>
            <div className='flex gap-5'>
              <div className='flex gap-2 justify-center items-center'>
              {/* <img src={removeCart} alt="" className='w-6'/> */}
